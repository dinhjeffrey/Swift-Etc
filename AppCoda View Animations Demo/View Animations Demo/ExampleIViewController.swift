...
class ExampleIViewController: UIViewController {
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        // layoutIfNeeded() is used to lay out the views immediately they are changed. If you don’t include it, you will not see them get animated onto the screen, instead they will just be shown in their final position.
